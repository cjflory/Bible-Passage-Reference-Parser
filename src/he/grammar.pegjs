...
cb
  = c_explicit val_1:c in_book_of? val_2:b
    { return {"type": "bc", "value": [val_2, val_1], "indices": [offset, pos - 1]} }

cb_range
  = c_explicit val_1:c range_sep val_2:c in_book_of? val_3:b
    { return {"type": "cb_range", "value": [val_3, val_1, val_2], "indices": [offset, pos - 1]} }
...
cv_psalm
  = val_1:c_psalm sequence_sep? v_explicit val_2:v
    { return {"type": "cv_psalm", "value": [val_1, val_2], "indices": [offset, pos - 1]} }

c_title
  = c_explicit val_1:c val_2:title
    { return {"type": "c_title", "value": [val_1, val_2], "indices": [offset, pos - 1]} }

cv
  = val_1:c !("." v_explicit v) (cv_sep? v_explicit / cv_sep) val_2:(v_letter / v)
    { return {"type": "cv", "value": [val_1, val_2], "indices": [offset, pos - 1]} }
...
translation_sequence_enclosed
  = sp [\(\[] sp val:(translation (sequence_sep translation)*) sp [\)\]]
    { return {"type": "translation_sequence", "value": val, "indices": [offset, pos - 1]} }
...
translation
  = "\x1e" val:any_integer "\x1e"
    { return {"type": "translation", "value": val.value, "indices": [offset, pos - 1]} }

/* Base nodes */
integer
  = en_integer / he_integer
...
he_int_parsed
  = val:[א-ט] { return val.charCodeAt(0) - 1487; }
...
word
  = val:( [^\x1f\x1e\(\[]+ )
    { return {"type": "word", "value": val.join(""), "indices": [offset, pos - 1]} }
...
word_parenthesis
  = val:[\(\[]
    { return {"type": "stop", "value": val, "indices": [offset, pos - 1]} }
