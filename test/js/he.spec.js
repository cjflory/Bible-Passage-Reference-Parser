(function() {
  ...
  describe("Parsing", function() {
    ...
    it("should round-trip OSIS Apocrypha references", function() {
      var bc, bcv, bcv_range, book, books, _i, _j, _len, _len2, _results;
      p.set_options({
        osis_compaction_strategy: "bc"
      });
      ...
      _results = [];
      for (_j = 0, _len2 = books.length; _j < _len2; _j++) {
        book = books[_j];
        bc = book + ".1";
  ...
  describe("Localized book names", function() {
    ...
    it("should handle book: Gen (he)", function() {
      ...
      expect(p.parse("בראשית 1:1").osis()).toEqual("Gen.1.1");
      expect(p.parse("בריאה 1:1").osis()).toEqual("Gen.1.1");
      return expect(p.parse("GEN 1:1").osis()).toEqual("Gen.1.1");
    });
    it("should handle book: Exod (he)", function() {
      ...
      expect(p.parse("יציאה 1:1").osis()).toEqual("Exod.1.1");
      expect(p.parse("EXOD 1:1").osis()).toEqual("Exod.1.1");
      return expect(p.parse("שמות 1:1").osis()).toEqual("Exod.1.1");
    });
    it("should handle book: Bel (he)", function() {
    ...
    it("should handle book: Lev (he)", function() {
      ...
      expect(p.parse("ספר הלוויים 1:1").osis()).toEqual("Lev.1.1");
      expect(p.parse("ויקרא 1:1").osis()).toEqual("Lev.1.1");
      return expect(p.parse("LEV 1:1").osis()).toEqual("Lev.1.1");
    });
    it("should handle book: Num (he)", function() {
      ...
      expect(p.parse("במדבר 1:1").osis()).toEqual("Num.1.1");
      expect(p.parse("מניין 1:1").osis()).toEqual("Num.1.1");
      return expect(p.parse("NUM 1:1").osis()).toEqual("Num.1.1");
    });
    it("should handle book: Sir (he)", function() {
      expect(p.parse("משלי בן-סירא 1:1").osis()).toEqual("Sir.1.1");
      expect(p.parse("משלי בן סירא 1:1").osis()).toEqual("Sir.1.1");
      expect(p.parse("ספר בן סירא 1:1").osis()).toEqual("Sir.1.1");
      return expect(p.parse("Sir 1:1").osis()).toEqual("Sir.1.1");
    });
    it("should handle book: Wis (he)", function() {
      expect(p.parse("חכמת שלמה 1:1").osis()).toEqual("Wis.1.1");
      return expect(p.parse("Wis 1:1").osis()).toEqual("Wis.1.1");
    });
    it("should handle book: Lam (he)", function() {
      ...
      expect(p.parse("קינות 1:1").osis()).toEqual("Lam.1.1");
      expect(p.parse("איכה 1:1").osis()).toEqual("Lam.1.1");
      return expect(p.parse("LAM 1:1").osis()).toEqual("Lam.1.1");
    });
    it("should handle book: EpJer (he)", function() {
      expect(p.parse("איגרת ירמיהו 1:1").osis()).toEqual("EpJer.1.1");
      return expect(p.parse("EpJer 1:1").osis()).toEqual("EpJer.1.1");
    });
    it("should handle book: Rev (he)", function() {
      ...
      expect(p.parse("ההתגלות 1:1").osis()).toEqual("Rev.1.1");
      expect(p.parse("התגלות 1:1").osis()).toEqual("Rev.1.1");
      return expect(p.parse("REV 1:1").osis()).toEqual("Rev.1.1");
    });
    it("should handle book: PrMan (he)", function() {
      expect(p.parse("תפילת מנשה 1:1").osis()).toEqual("PrMan.1.1");
      return expect(p.parse("PrMan 1:1").osis()).toEqual("PrMan.1.1");
    });
    it("should handle book: Deut (he)", function() {
      ...
      expect(p.parse("משנה תורה 1:1").osis()).toEqual("Deut.1.1");
      expect(p.parse("דברים 1:1").osis()).toEqual("Deut.1.1");
      return expect(p.parse("DEUT 1:1").osis()).toEqual("Deut.1.1");
    });
    it("should handle book: Josh (he)", function() {
      expect(p.parse("יהושע 1:1").osis()).toEqual("Josh.1.1");
      expect(p.parse("Josh 1:1").osis()).toEqual("Josh.1.1");
      p.include_apocrypha(false);
      expect(p.parse("יהושע 1:1").osis()).toEqual("Josh.1.1");
      return expect(p.parse("JOSH 1:1").osis()).toEqual("Josh.1.1");
    });
    it("should handle book: Judg (he)", function() {
      expect(p.parse("שופטים 1:1").osis()).toEqual("Judg.1.1");
      expect(p.parse("Judg 1:1").osis()).toEqual("Judg.1.1");
      p.include_apocrypha(false);
      expect(p.parse("שופטים 1:1").osis()).toEqual("Judg.1.1");
      return expect(p.parse("JUDG 1:1").osis()).toEqual("Judg.1.1");
    });
    it("should handle book: Ruth (he)", function() {
      expect(p.parse("Ruth 1:1").osis()).toEqual("Ruth.1.1");
      expect(p.parse("רות 1:1").osis()).toEqual("Ruth.1.1");
      p.include_apocrypha(false);
      expect(p.parse("RUTH 1:1").osis()).toEqual("Ruth.1.1");
      return expect(p.parse("רות 1:1").osis()).toEqual("Ruth.1.1");
    });
    it("should handle book: 1Esd (he)", function() {
      expect(p.parse("חזון עזרא 1:1").osis()).toEqual("1Esd.1.1");
      return expect(p.parse("1Esd 1:1").osis()).toEqual("1Esd.1.1");
    });
    it("should handle book: 2Esd (he)", function() {
      expect(p.parse("עזרא החיצוני 1:1").osis()).toEqual("2Esd.1.1");
      return expect(p.parse("2Esd 1:1").osis()).toEqual("2Esd.1.1");
    });
    it("should handle book: Isa (he)", function() {
      ...
      expect(p.parse("ישעיה 1:1").osis()).toEqual("Isa.1.1");
      expect(p.parse("ישעה 1:1").osis()).toEqual("Isa.1.1");
      return expect(p.parse("ISA 1:1").osis()).toEqual("Isa.1.1");
    });
    it("should handle book: 2Sam (he)", function() {
      ...
      expect(p.parse("שמואל ב' 1:1").osis()).toEqual("2Sam.1.1");
      expect(p.parse("שמואל ב 1:1").osis()).toEqual("2Sam.1.1");
      return expect(p.parse("2SAM 1:1").osis()).toEqual("2Sam.1.1");
    });
    it("should handle book: 1Sam (he)", function() {
      ...
      expect(p.parse("שמואל א’ 1:1").osis()).toEqual("1Sam.1.1");
      expect(p.parse("שמואל א 1:1").osis()).toEqual("1Sam.1.1");
      return expect(p.parse("1SAM 1:1").osis()).toEqual("1Sam.1.1");
    });
    it("should handle book: 2Kgs (he)", function() {
      ...
      expect(p.parse("מלכים ב’ 1:1").osis()).toEqual("2Kgs.1.1");
      expect(p.parse("מלכים ב 1:1").osis()).toEqual("2Kgs.1.1");
      return expect(p.parse("2KGS 1:1").osis()).toEqual("2Kgs.1.1");
    });
    it("should handle book: 1Kgs (he)", function() {
      ...
      expect(p.parse("מלכים א’ 1:1").osis()).toEqual("1Kgs.1.1");
      expect(p.parse("מלכים א 1:1").osis()).toEqual("1Kgs.1.1");
      return expect(p.parse("1KGS 1:1").osis()).toEqual("1Kgs.1.1");
    });
    it("should handle book: 2Chr (he)", function() {
    ...
    it("should handle book: 1Chr (he)", function() {
      ...
      expect(p.parse("דברי הימים א' 1:1").osis()).toEqual("1Chr.1.1");
      expect(p.parse("דברי הימים א 1:1").osis()).toEqual("1Chr.1.1");
      return expect(p.parse("1CHR 1:1").osis()).toEqual("1Chr.1.1");
    });
    it("should handle book: Ezra (he)", function() {
      expect(p.parse("עזרא 1:1").osis()).toEqual("Ezra.1.1");
      expect(p.parse("Ezra 1:1").osis()).toEqual("Ezra.1.1");
      p.include_apocrypha(false);
      expect(p.parse("עזרא 1:1").osis()).toEqual("Ezra.1.1");
      return expect(p.parse("EZRA 1:1").osis()).toEqual("Ezra.1.1");
    });
    it("should handle book: Neh (he)", function() {
      expect(p.parse("נחמיה 1:1").osis()).toEqual("Neh.1.1");
      expect(p.parse("Neh 1:1").osis()).toEqual("Neh.1.1");
      p.include_apocrypha(false);
      expect(p.parse("נחמיה 1:1").osis()).toEqual("Neh.1.1");
      return expect(p.parse("NEH 1:1").osis()).toEqual("Neh.1.1");
    });
    it("should handle book: GkEsth (he)", function() {
      expect(p.parse("תוספות למגילת אסתר 1:1").osis()).toEqual("GkEsth.1.1");
      return expect(p.parse("GkEsth 1:1").osis()).toEqual("GkEsth.1.1");
    });
    it("should handle book: Esth (he)", function() {
      ...
      expect(p.parse("אסתר, כולל פרקים גנוזים 1:1").osis()).toEqual("Esth.1.1");
      expect(p.parse("אסתר 1:1").osis()).toEqual("Esth.1.1");
      return expect(p.parse("ESTH 1:1").osis()).toEqual("Esth.1.1");
    });
    it("should handle book: Job (he)", function() {
      expect(p.parse("איוב 1:1").osis()).toEqual("Job.1.1");
      expect(p.parse("Job 1:1").osis()).toEqual("Job.1.1");
      p.include_apocrypha(false);
      expect(p.parse("איוב 1:1").osis()).toEqual("Job.1.1");
      return expect(p.parse("JOB 1:1").osis()).toEqual("Job.1.1");
    });
    it("should handle book: Ps (he)", function() {
    ...
    it("should handle book: PrAzar (he)", function() {
    ...
    it("should handle book: Prov (he)", function() {
      ...
      expect(p.parse("משלים 1:1").osis()).toEqual("Prov.1.1");
      expect(p.parse("PROV 1:1").osis()).toEqual("Prov.1.1");
      return expect(p.parse("משלי 1:1").osis()).toEqual("Prov.1.1");
    });
    it("should handle book: Eccl (he)", function() {
      ...
      expect(p.parse("המרצה 1:1").osis()).toEqual("Eccl.1.1");
      expect(p.parse("ECCL 1:1").osis()).toEqual("Eccl.1.1");
      return expect(p.parse("קהלת 1:1").osis()).toEqual("Eccl.1.1");
    });
    it("should handle book: SgThree (he)", function() {
      expect(p.parse("שירת שלושת הנערים בכבשן 1:1").osis()).toEqual("SgThree.1.1");
      return expect(p.parse("SgThree 1:1").osis()).toEqual("SgThree.1.1");
    });
    it("should handle book: Song (he)", function() {
      ...
      expect(p.parse("שיר השירים 1:1").osis()).toEqual("Song.1.1");
      expect(p.parse("שירי שלמה 1:1").osis()).toEqual("Song.1.1");
      return expect(p.parse("SONG 1:1").osis()).toEqual("Song.1.1");
    });
    it("should handle book: Jer (he)", function() {
      ...
      expect(p.parse("ירמיהו 1:1").osis()).toEqual("Jer.1.1");
      expect(p.parse("ירמיה 1:1").osis()).toEqual("Jer.1.1");
      return expect(p.parse("JER 1:1").osis()).toEqual("Jer.1.1");
    });
    it("should handle book: Ezek (he)", function() {
      expect(p.parse("יחזקאל 1:1").osis()).toEqual("Ezek.1.1");
      expect(p.parse("Ezek 1:1").osis()).toEqual("Ezek.1.1");
      p.include_apocrypha(false);
      expect(p.parse("יחזקאל 1:1").osis()).toEqual("Ezek.1.1");
      return expect(p.parse("EZEK 1:1").osis()).toEqual("Ezek.1.1");
    });
    it("should handle book: Dan (he)", function() {
      expect(p.parse("דניאל 1:1").osis()).toEqual("Dan.1.1");
      expect(p.parse("Dan 1:1").osis()).toEqual("Dan.1.1");
      p.include_apocrypha(false);
      expect(p.parse("דניאל 1:1").osis()).toEqual("Dan.1.1");
      return expect(p.parse("DAN 1:1").osis()).toEqual("Dan.1.1");
    });
    it("should handle book: Hos (he)", function() {
      expect(p.parse("הושע 1:1").osis()).toEqual("Hos.1.1");
      expect(p.parse("Hos 1:1").osis()).toEqual("Hos.1.1");
      p.include_apocrypha(false);
      expect(p.parse("הושע 1:1").osis()).toEqual("Hos.1.1");
      return expect(p.parse("HOS 1:1").osis()).toEqual("Hos.1.1");
    });
    it("should handle book: Joel (he)", function() {
      expect(p.parse("Joel 1:1").osis()).toEqual("Joel.1.1");
      expect(p.parse("יואל 1:1").osis()).toEqual("Joel.1.1");
      p.include_apocrypha(false);
      expect(p.parse("JOEL 1:1").osis()).toEqual("Joel.1.1");
      return expect(p.parse("יואל 1:1").osis()).toEqual("Joel.1.1");
    });
    it("should handle book: Amos (he)", function() {
      expect(p.parse("עמוס 1:1").osis()).toEqual("Amos.1.1");
      expect(p.parse("Amos 1:1").osis()).toEqual("Amos.1.1");
      p.include_apocrypha(false);
      expect(p.parse("עמוס 1:1").osis()).toEqual("Amos.1.1");
      return expect(p.parse("AMOS 1:1").osis()).toEqual("Amos.1.1");
    });
    it("should handle book: Obad (he)", function() {
      ...
      expect(p.parse("עובדיה 1:1").osis()).toEqual("Obad.1.1");
      expect(p.parse("עבדיה 1:1").osis()).toEqual("Obad.1.1");
      return expect(p.parse("OBAD 1:1").osis()).toEqual("Obad.1.1");
    });
    it("should handle book: Jonah (he)", function() {
      expect(p.parse("Jonah 1:1").osis()).toEqual("Jonah.1.1");
      expect(p.parse("יונה 1:1").osis()).toEqual("Jonah.1.1");
      p.include_apocrypha(false);
      expect(p.parse("JONAH 1:1").osis()).toEqual("Jonah.1.1");
      return expect(p.parse("יונה 1:1").osis()).toEqual("Jonah.1.1");
    });
    it("should handle book: Mic (he)", function() {
      expect(p.parse("מיכה 1:1").osis()).toEqual("Mic.1.1");
      expect(p.parse("Mic 1:1").osis()).toEqual("Mic.1.1");
      p.include_apocrypha(false);
      expect(p.parse("מיכה 1:1").osis()).toEqual("Mic.1.1");
      return expect(p.parse("MIC 1:1").osis()).toEqual("Mic.1.1");
    });
    it("should handle book: Nah (he)", function() {
      expect(p.parse("נחום 1:1").osis()).toEqual("Nah.1.1");
      expect(p.parse("Nah 1:1").osis()).toEqual("Nah.1.1");
      p.include_apocrypha(false);
      expect(p.parse("נחום 1:1").osis()).toEqual("Nah.1.1");
      return expect(p.parse("NAH 1:1").osis()).toEqual("Nah.1.1");
    });
    it("should handle book: Hab (he)", function() {
      expect(p.parse("חבקוק 1:1").osis()).toEqual("Hab.1.1");
      expect(p.parse("Hab 1:1").osis()).toEqual("Hab.1.1");
      p.include_apocrypha(false);
      expect(p.parse("חבקוק 1:1").osis()).toEqual("Hab.1.1");
      return expect(p.parse("HAB 1:1").osis()).toEqual("Hab.1.1");
    });
    it("should handle book: Zeph (he)", function() {
      expect(p.parse("Zeph 1:1").osis()).toEqual("Zeph.1.1");
      expect(p.parse("חגי 1:1").osis()).toEqual("Zeph.1.1");
      p.include_apocrypha(false);
      expect(p.parse("ZEPH 1:1").osis()).toEqual("Zeph.1.1");
      return expect(p.parse("חגי 1:1").osis()).toEqual("Zeph.1.1");
    });
    it("should handle book: Hag (he)", function() {
      expect(p.parse("צפניה 1:1").osis()).toEqual("Hag.1.1");
      expect(p.parse("Hag 1:1").osis()).toEqual("Hag.1.1");
      p.include_apocrypha(false);
      expect(p.parse("צפניה 1:1").osis()).toEqual("Hag.1.1");
      return expect(p.parse("HAG 1:1").osis()).toEqual("Hag.1.1");
    });
    it("should handle book: Zech (he)", function() {
      expect(p.parse("זכריה 1:1").osis()).toEqual("Zech.1.1");
      expect(p.parse("Zech 1:1").osis()).toEqual("Zech.1.1");
      p.include_apocrypha(false);
      expect(p.parse("זכריה 1:1").osis()).toEqual("Zech.1.1");
      return expect(p.parse("ZECH 1:1").osis()).toEqual("Zech.1.1");
    });
    it("should handle book: Mal (he)", function() {
      expect(p.parse("מלאכי 1:1").osis()).toEqual("Mal.1.1");
      expect(p.parse("Mal 1:1").osis()).toEqual("Mal.1.1");
      p.include_apocrypha(false);
      expect(p.parse("מלאכי 1:1").osis()).toEqual("Mal.1.1");
      return expect(p.parse("MAL 1:1").osis()).toEqual("Mal.1.1");
    });
    it("should handle book: Matt (he)", function() {
    ...
    it("should handle book: Mark (he)", function() {
      ...
      expect(p.parse("הבשורה על-פי מרקוס 1:1").osis()).toEqual("Mark.1.1");
      expect(p.parse("הבשורה על פי מרקוס 1:1").osis()).toEqual("Mark.1.1");
      return expect(p.parse("MARK 1:1").osis()).toEqual("Mark.1.1");
    });
    it("should handle book: Luke (he)", function() {
      ...
      expect(p.parse("הבשורה על-פי לוקס 1:1").osis()).toEqual("Luke.1.1");
      expect(p.parse("הבשורה על פי לוקס 1:1").osis()).toEqual("Luke.1.1");
      return expect(p.parse("LUKE 1:1").osis()).toEqual("Luke.1.1");
    });
    it("should handle book: 1John (he)", function() {
      ...
      expect(p.parse("אגרתו הראשונה של יוחנן השלי 1:1").osis()).toEqual("1John.1.1");
      expect(p.parse("איגרת יוחנן הראשונה 1:1").osis()).toEqual("1John.1.1");
      return expect(p.parse("1JOHN 1:1").osis()).toEqual("1John.1.1");
    });
    it("should handle book: 2John (he)", function() {
      ...
      expect(p.parse("אגרתו השנייה של יוחנן השליח 1:1").osis()).toEqual("2John.1.1");
      expect(p.parse("איגרת יוחנן השנייה 1:1").osis()).toEqual("2John.1.1");
      return expect(p.parse("2JOHN 1:1").osis()).toEqual("2John.1.1");
    });
    it("should handle book: 3John (he)", function() {
      ...
      expect(p.parse("אגרתו השלישית של יוחנן השלי 1:1").osis()).toEqual("3John.1.1");
      expect(p.parse("איגרת יוחנן השלישית 1:1").osis()).toEqual("3John.1.1");
      return expect(p.parse("3JOHN 1:1").osis()).toEqual("3John.1.1");
    });
    it("should handle book: John (he)", function() {
      ...
      expect(p.parse("הבשורה על פי יוחנן 1:1").osis()).toEqual("John.1.1");
      expect(p.parse("הבשורה על-פי יוחנן 1:1").osis()).toEqual("John.1.1");
      return expect(p.parse("JOHN 1:1").osis()).toEqual("John.1.1");
    });
    it("should handle book: Acts (he)", function() {
      expect(p.parse("מעשי השליחים 1:1").osis()).toEqual("Acts.1.1");
      expect(p.parse("Acts 1:1").osis()).toEqual("Acts.1.1");
      p.include_apocrypha(false);
      expect(p.parse("מעשי השליחים 1:1").osis()).toEqual("Acts.1.1");
      return expect(p.parse("ACTS 1:1").osis()).toEqual("Acts.1.1");
    });
    it("should handle book: Rom (he)", function() {
      ...
      expect(p.parse("אל הרומאים 1:1").osis()).toEqual("Rom.1.1");
      expect(p.parse("אל הרומים 1:1").osis()).toEqual("Rom.1.1");
      return expect(p.parse("ROM 1:1").osis()).toEqual("Rom.1.1");
    });
    it("should handle book: 2Cor (he)", function() {
    ...
    it("should handle book: 1Cor (he)", function() {
      ...
      expect(p.parse("אגרת פולוס הראשונה אל-הקורי 1:1").osis()).toEqual("1Cor.1.1");
      expect(p.parse("הראשונה אל הקורינתים 1:1").osis()).toEqual("1Cor.1.1");
      return expect(p.parse("1COR 1:1").osis()).toEqual("1Cor.1.1");
    });
    it("should handle book: Gal (he)", function() {
      ...
      expect(p.parse("האיגרת אל הגלטים 1:1").osis()).toEqual("Gal.1.1");
      expect(p.parse("אל הגלטים 1:1").osis()).toEqual("Gal.1.1");
      return expect(p.parse("GAL 1:1").osis()).toEqual("Gal.1.1");
    });
    it("should handle book: Eph (he)", function() {
      ...
      expect(p.parse("האיגרת אל האפסים 1:1").osis()).toEqual("Eph.1.1");
      expect(p.parse("אל האפסים 1:1").osis()).toEqual("Eph.1.1");
      return expect(p.parse("EPH 1:1").osis()).toEqual("Eph.1.1");
    });
    it("should handle book: Phil (he)", function() {
      ...
      expect(p.parse("האיגרת אל הפיליפים 1:1").osis()).toEqual("Phil.1.1");
      expect(p.parse("אל הפיליפים 1:1").osis()).toEqual("Phil.1.1");
      return expect(p.parse("PHIL 1:1").osis()).toEqual("Phil.1.1");
    });
    it("should handle book: Col (he)", function() {
    ...
    it("should handle book: 2Thess (he)", function() {
      ...
      expect(p.parse("אגרת פולוס השנייה אל-התסלונ 1:1").osis()).toEqual("2Thess.1.1");
      expect(p.parse("השנייה אל התסלוניקים 1:1").osis()).toEqual("2Thess.1.1");
      return expect(p.parse("2THESS 1:1").osis()).toEqual("2Thess.1.1");
    });
    it("should handle book: 1Thess (he)", function() {
      ...
      expect(p.parse("אגרת פולוס הראשונה אל-התסלו 1:1").osis()).toEqual("1Thess.1.1");
      expect(p.parse("הראשונה אל התסלוניקים 1:1").osis()).toEqual("1Thess.1.1");
      return expect(p.parse("1THESS 1:1").osis()).toEqual("1Thess.1.1");
    });
    it("should handle book: 2Tim (he)", function() {
      ...
      expect(p.parse("השנייה אל טימותיאוס 1:1").osis()).toEqual("2Tim.1.1");
      expect(p.parse("השנייה אל טימותיוס 1:1").osis()).toEqual("2Tim.1.1");
      return expect(p.parse("2TIM 1:1").osis()).toEqual("2Tim.1.1");
    });
    it("should handle book: 1Tim (he)", function() {
    ...
    it("should handle book: Titus (he)", function() {
      ...
      expect(p.parse("האיגרת אל טיטוס 1:1").osis()).toEqual("Titus.1.1");
      expect(p.parse("אל טיטוס 1:1").osis()).toEqual("Titus.1.1");
      return expect(p.parse("TITUS 1:1").osis()).toEqual("Titus.1.1");
    });
    it("should handle book: Phlm (he)", function() {
      ...
      expect(p.parse("האיגרת אל פילימון 1:1").osis()).toEqual("Phlm.1.1");
      expect(p.parse("אל פילימון 1:1").osis()).toEqual("Phlm.1.1");
      return expect(p.parse("PHLM 1:1").osis()).toEqual("Phlm.1.1");
    });
    it("should handle book: Heb (he)", function() {
      ...
      expect(p.parse("האגרת אל-העברים 1:1").osis()).toEqual("Heb.1.1");
      expect(p.parse("אל העברים 1:1").osis()).toEqual("Heb.1.1");
      return expect(p.parse("HEB 1:1").osis()).toEqual("Heb.1.1");
    });
    it("should handle book: Jas (he)", function() {
      ...
      expect(p.parse("איגרת יעקב 1:1").osis()).toEqual("Jas.1.1");
      expect(p.parse("אגרת יעקב 1:1").osis()).toEqual("Jas.1.1");
      return expect(p.parse("JAS 1:1").osis()).toEqual("Jas.1.1");
    });
    it("should handle book: 2Pet (he)", function() {
      ...
      expect(p.parse("אגרתו השנייה של פטרוס השליח 1:1").osis()).toEqual("2Pet.1.1");
      expect(p.parse("איגרת פטרוס השנייה 1:1").osis()).toEqual("2Pet.1.1");
      return expect(p.parse("2PET 1:1").osis()).toEqual("2Pet.1.1");
    });
    it("should handle book: 1Pet (he)", function() {
      ...
      expect(p.parse("אגרתו הראשונה של פטרוס השלי 1:1").osis()).toEqual("1Pet.1.1");
      expect(p.parse("איגרת פטרוס הראשונה 1:1").osis()).toEqual("1Pet.1.1");
      return expect(p.parse("1PET 1:1").osis()).toEqual("1Pet.1.1");
    });
    it("should handle book: Jude (he)", function() {
      ...
      expect(p.parse("איגרת יהודה 1:1").osis()).toEqual("Jude.1.1");
      expect(p.parse("אגרת יהודה 1:1").osis()).toEqual("Jude.1.1");
      return expect(p.parse("JUDE 1:1").osis()).toEqual("Jude.1.1");
    });
    it("should handle book: Tob (he)", function() {
      expect(p.parse("טוביה 1:1").osis()).toEqual("Tob.1.1");
      return expect(p.parse("Tob 1:1").osis()).toEqual("Tob.1.1");
    });
    it("should handle book: Jdt (he)", function() {
      expect(p.parse("יהודית 1:1").osis()).toEqual("Jdt.1.1");
      return expect(p.parse("Jdt 1:1").osis()).toEqual("Jdt.1.1");
    });
    it("should handle book: Bar (he)", function() {
      expect(p.parse("ספר ברוך 1:1").osis()).toEqual("Bar.1.1");
      expect(p.parse("ברוך 1:1").osis()).toEqual("Bar.1.1");
      return expect(p.parse("Bar 1:1").osis()).toEqual("Bar.1.1");
    });
    it("should handle book: Sus (he)", function() {
      expect(p.parse("שושנה 1:1").osis()).toEqual("Sus.1.1");
      return expect(p.parse("Sus 1:1").osis()).toEqual("Sus.1.1");
    });
    it("should handle book: 2Macc (he)", function() {
      ...
      return expect(p.parse("2Macc 1:1").osis()).toEqual("2Macc.1.1");
    });
    it("should handle book: 3Macc (he)", function() {
      ...
      return expect(p.parse("3Macc 1:1").osis()).toEqual("3Macc.1.1");
    });
    it("should handle book: 4Macc (he)", function() {
      ...
      return expect(p.parse("4Macc 1:1").osis()).toEqual("4Macc.1.1");
    });
    it("should handle book: 1Macc (he)", function() {
      ...
      return expect(p.parse("1Macc 1:1").osis()).toEqual("1Macc.1.1");
    });
    ...
    return it("should handle translations (he)", function() {
  ...
  it("should handle boundaries (he)", function() {
    p.set_options({
